      ...
      <section className="py-20 bg-white dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-xl bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Free Shipping</h3>
            ...
            <div className="text-center p-8 rounded-xl bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
              <div className="bg-emerald-100 dark:bg-emerald-900 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                <Shield className="h-8 w-8 text-emerald-600 dark:text-emerald-400" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Secure Shopping</h3>
              <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group cursor-pointer">
              <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Urban Casual</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">Comfortable everyday wear that doesn't compromise on style.</p>
                  <span className="text-indigo-600 dark:text-indigo-400 font-semibold group-hover:text-indigo-800 dark:group-hover:text-indigo-300 transition-colors duration-200">
                    Explore Collection →
                  </span>
                </div>
              </div>
            ...
            <div className="group cursor-pointer">
              <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Elegant Evening</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">Sophisticated pieces for special occasions and nights out.</p>
                  <span className="text-indigo-600 dark:text-indigo-400 font-semibold group-hover:text-indigo-800 dark:group-hover:text-indigo-300 transition-colors duration-200">
                    Explore Collection →
                  </span>
                </div>
            ...
            <div className="group cursor-pointer">
              <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Active Lifestyle</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">Performance wear that keeps up with your active lifestyle.</p>
                  <span className="text-indigo-600 dark:text-indigo-400 font-semibold group-hover:text-indigo-800 dark:group-hover:text-indigo-300 transition-colors duration-200">
                    Explore Collection →
                  </span>
                </div>
